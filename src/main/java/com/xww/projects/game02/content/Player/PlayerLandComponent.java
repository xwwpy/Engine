...
public class PlayerLandComponent extends FreeComponent {
    public Animation animation;
    public PlayerLandComponent(Vector worldPosition) {
        super(worldPosition,
        ...
        animation.add_frame(ResourceManager.getInstance().findImage("player_vfx_land"), 4, size);
