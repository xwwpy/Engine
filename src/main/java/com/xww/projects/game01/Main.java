...
public class Main {
    ...
    public static void initGame(){
        ...
        TestRelativeComponent child1 = new TestRelativeComponent(component, Vector.build(100, 100), AnchorMode.LeftTop, Vector.build(30, 0), Vector.Zero(),   Vector.build(50, 200), false, 1, 0x0001, 0x000);
        child1.addCollider(new RectCollider(Vector.build(0, 0), child1, child1.getSize()));
        component.addChild(child1);
        TestRelativeComponent child2 = new TestRelativeComponent(child1, Vector.build(50, 50), AnchorMode.LeftTop, Vector.build(10, 0), Vector.Zero(),  Vector.build(50, 200), false, 1, 0x0001, 0x000);
        child1.addChild(child2);
        child2.addCollider(new RectCollider(Vector.Zero(), child2, child2.getSize()));
        Component.addComponent(component);
        Component.addComponent(new TestComponent(Vector.build(200, 200), Vector.build(100, 100), AnchorMode.LeftTop, Vector.build(0, 50), Vector.Zero(), 0, 0x0001, 0x000));
        Component.addComponent(new TestComponent(Vector.build(300, 300), Vector.build(100, 100), AnchorMode.LeftTop, Vector.Zero(), Vector.Zero(), 0, 0x0001, 0x000));
        Component.addComponent(new TestComponent(Vector.build(400, 400), Vector.build(100, 100), AnchorMode.LeftTop, Vector.Zero(), Vector.Zero(), 0,0x0001, 0x000));
        Component.addComponent(new TestComponent(Vector.build(600, 200), Vector.build(200, 100), AnchorMode.LeftTop, Vector.Zero(), Vector.Zero(), 0, 0x0001, 0x000));
        Component.addComponent(new TestComponent(Vector.build(200, 600), Vector.build(100, 100), AnchorMode.LeftTop, Vector.Zero(), Vector.Zero(), 0, 0x0001, 0x000));

        TestComponent testComponent = new TestComponent(Vector.build(600, 550), Vector.build(100, 150), AnchorMode.RightTop, Vector.build(0, 0), Vector.Zero(), 0, 0x0001, 0x000);
        ...
        TestRelativeComponent testRelativeComponent = new TestRelativeComponent(testComponent, Vector.build(50, 60), AnchorMode.LeftTop, Vector.build(500, 0), Vector.build(50, 20), Vector.build(300, 0), true, 0, 0x0001, 0x000);
        ...
        TestRelativeComponent testRelativeComponent1 = new TestRelativeComponent(testRelativeComponent, Vector.build(30, 30), AnchorMode.LeftTop, Vector.build(20, 0), Vector.build(0, 0), Vector.build(100, 0), true, 0, 0x0001, 0x000);
        ...
        TestComponent testComponent1 = new TestComponent(Vector.build(1100, 600), Vector.build(100, 100), AnchorMode.LeftBottom, Vector.build(100, 20), Vector.Zero(), 0, 0x0001, 0x000);
