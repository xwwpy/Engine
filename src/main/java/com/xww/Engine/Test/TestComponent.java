...
public class TestComponent extends FreeComponent {
    ...
    int countG = 1;
    int countB = 1;
    public TestComponent(Vector worldPosition, Vector size, AnchorMode anchorMode, Vector velocity, Vector acceleration, int order, int activeCollisionZone, int hitCollisionZone) {
        super(worldPosition, GameFrame.PositionType.World, size, anchorMode, velocity, acceleration, order, activeCollisionZone, hitCollisionZone, 10,true, true);
